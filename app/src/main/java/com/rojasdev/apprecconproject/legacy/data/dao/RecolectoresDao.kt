...
import com.rojasdev.apprecconproject.legacy.data.dataModel.collectorCollection
import com.rojasdev.apprecconproject.legacy.data.dataModel.pdfModel
import com.rojasdev.apprecconproject.legacy.data.dataModel.totalPdf
import com.rojasdev.apprecconproject.legacy.data.dataModel.workMen
...
interface RecolectoresDao {
    ...
    @Query(
        "SELECT r.PK_ID_Recolector ,r.name_recolector, sum(wor.Cantidad) " +
    ...
    @Query(
        "SELECT r.PK_ID_Recolector, r.name_recolector, re.PK_ID_Recoleccion, re.Cantidad, " +
    ...
    @Query(
        "SELECT r.PK_ID_Recolector, r.name_recolector, wo.PK_ID_Trabajo, wo.cantidad, " +
    ...
    @Query(
        "SELECT r.PK_ID_Recolector, r.name_recolector, wor.PK_ID_Trabajo, SUM(wor.Cantidad) AS cantidad, " +
    ...
    @Query(
        "SELECT r.PK_ID_Recolector, r.name_recolector, re.Estado, con.Alimentacion, " +
    ...
    @Query(
        "SELECT r.PK_ID_Recolector, r.name_recolector, wor.Estado, wor.actividad, con.Alimentacion, " +
