...
class viewHolderDays( var view: View): RecyclerView.ViewHolder(view) {
    ...
    fun render(
        hoy : String,
        item: com.rojasdev.apprecconproject.legacy.customCalendar.dataModelDay,
    ...
    private fun activity(item: com.rojasdev.apprecconproject.legacy.customCalendar.dataModelDay, list: List<String>, view: View){
