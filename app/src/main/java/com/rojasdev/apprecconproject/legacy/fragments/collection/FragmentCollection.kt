...
class FragmentCollection(
    ...
    var preferences:()-> Unit) : androidx.fragment.app.Fragment()
{
    private var _binding: FragmentCollectorsAndCollecionBinding? = null
    private lateinit var adapter: com.rojasdev.apprecconproject.legacy.adapters.adapterRvCollectionTotal
