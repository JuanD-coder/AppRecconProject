...
class adapterRvCollectors(
    ...
    private val onClickListenerKg: (RecolectoresEntity) -> Unit
) : RecyclerView.Adapter<viewHolderCvCollectors>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): viewHolderCvCollectors {
        return viewHolderCvCollectors(
    ...
    fun updateData(newList: List<RecolectoresEntity>, newIds: List<Long>) {
        this.items = newList
        this.list = newIds
