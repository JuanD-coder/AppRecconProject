...
import com.rojasdev.apprecconprojectPro.data.dataModel.totalWeekPdf
...
interface SettingDao {
    ...
    @Insert
    suspend fun InsertconfigNew(config:List<SettingEntity>)
    ...
    suspend fun getAlimentTo(): List<SettingEntity>
